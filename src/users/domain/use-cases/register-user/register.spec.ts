...
describe('Register User', () => {
  ...
  beforeEach(async () => {
    ...
    inMemoryUserRepository = module.get<InMemoryUserRepository>(InMemoryUserRepository);
  });
  ...
  it('should throw ConflictException when trying to register a user with existing email', async () => {
    ...
    await expect(registerUserUseCase.execute(existingUser)).rejects.toThrow(ConflictException);
  });
});